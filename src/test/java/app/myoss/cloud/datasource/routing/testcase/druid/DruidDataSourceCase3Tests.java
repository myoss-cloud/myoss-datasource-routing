...
import app.myoss.cloud.datasource.routing.testcase.druid.DruidDataSourceCase3Tests.MyConfig;
...
/**
 * {@link DruidDataSource} 数据源路由测试，master/slave数据库是同一个库。增加全局配置测试覆盖
