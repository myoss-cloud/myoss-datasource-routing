 ...
 * {@link app.myoss.cloud.datasource.routing.constants.MethodPointcutEnum#JdkRegexpMethod}
 ...
 */
@ActiveProfiles({ "h2-hikari-case3", "HikariDataSourceCase3Tests" })
@Slf4j
...
public class HikariDataSourceCase3Tests {
    @Autowired
    ...
    @ComponentScan(basePackageClasses = HikariDataSourceCase3Tests.class)
    @Profile("HikariDataSourceCase3Tests")
    @Configuration
