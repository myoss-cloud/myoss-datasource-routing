...
import app.myoss.cloud.datasource.routing.testcase.hikari.HikariDataSourceCase5Tests.MyConfig;
...
/**
 * {@link HikariDataSource} 数据源路由测试，master/slave数据库是同一个库。增加全局配置测试覆盖
 * {@link app.myoss.cloud.datasource.routing.spring.boot.autoconfigure.DataSourceRoutingProperties#globalDatabaseProperties}
 *
 * @author Jerry.Chen
 * @since 2019年5月9日 下午11:43:27
 */
@Slf4j
@ActiveProfiles({ "h2-hikari-case5", "HikariDataSourceCase5Tests" })
...
public class HikariDataSourceCase5Tests {
    @Autowired
